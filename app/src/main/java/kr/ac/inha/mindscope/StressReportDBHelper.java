...
public class StressReportDBHelper extends SQLiteOpenHelper {
    ...
    private static final String STRESS_REPORT_COL_0 = "REPORT_TIMESTAMP";
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        sqLiteDatabase.execSQL("create table " + STRESS_REPORT_TABLE +
                "(" +
                STRESS_REPORT_COL_0 + " INTEGER DEFAULT(0), " +
    ...
    public synchronized void insertStressReportData(long timestamp, int stress_level, int day_num, int report_order, int accuracy, String feature_ids){
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues contentValues = new ContentValues();
        contentValues.put(STRESS_REPORT_COL_0, timestamp);
...
//        Cursor res = db.rawQuery("select  from " + STRESS_REPORT_TABLE, null);
        ...
        if(res != null && res.moveToFirst()){
            do{
                stressReportDataArray.add(new StressReportData(res.getLong(res.getColumnIndex(STRESS_REPORT_COL_0)),
                        res.getInt(res.getColumnIndex(STRESS_REPORT_COL_1)),
    ...
    public class StressReportData{
        ...
        public StressReportData(long timestamp, int stress_level, int day_num, int report_order, int accuracy, String feature_ids){
        ...
        public String toString(){
            return String.format(Locale.KOREA, "%d %d %d %d %s", stress_level, day_num, report_order, accuracy, feature_ids);
        }

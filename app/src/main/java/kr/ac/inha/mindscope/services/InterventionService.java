...
//                        STRESS_PUSH_NOTI_SENT, PATH_NOTIFICATION);
            ...
            if (remoteInput != null) {
                ...
                openMindscope.putExtra("change_intervention", false);
        ...
        if (notificationManager != null) {
            if (!action_diff_int) notificationManager.cancel(ZATURI_NOTIFICATION_ID);
        }
